...
- [devtools](https://cran.r-project.org/web/packages/devtools/index.html) like a 'tidyverse' for package development.
- [usethis](https://cran.r-project.org/web/packages/usethis/index.html) automating package configuration tasks.
...
After populating the roxygen comments for exported functions want to document them.
...
(should not have `library(magrittr)` in package function.)
